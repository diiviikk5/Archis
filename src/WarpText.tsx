...
const getFontValue = (value: string | number | undefined) => (typeof value === 'number' ? `${value}px` : value || '');
...
const syncUniforms = (program: any, props: WarpTextPropsRef) => {
...
export const WarpText: React.FC<WarpTextProps> = ({
  ...
  const propsRef = useRef<WarpTextPropsRef>({
    text,
    color,
    fontSize,
    fontWeight,
