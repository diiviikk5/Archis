# Target Beacon Optical Intensity Profile

## Overview
Laser beacon characteristics, Gaussian beam divergence, airy disc diffraction patterns, and 10x10 px cross-section modeling.
