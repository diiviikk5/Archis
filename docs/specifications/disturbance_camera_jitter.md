# High-Frequency Spacecraft Micro-Jitter (±20 px)

## Overview
Reaction wheel unbalance harmonics, structural resonance frequencies (50-200 Hz), and multi-axis angular jitter.
