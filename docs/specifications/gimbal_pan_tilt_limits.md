# Pan-Tilt Slew Rate Constraints (5-10 deg/s)

## Overview
Mechanical acceleration curves, Lorentz voice-coil actuator dynamics, and torque limits for high-speed tracking.
