...
| Centroid RMSE | ≤ 10 px | 0.025–0.037 px | PASS |
| Pointing RMSE | ≤ 10 px | 1.681–1.687 px | PASS |
| Target loss | < 5% | 0.00% | PASS |
| Worst re-acquisition | ≤ 1.0 s when applicable | n/a | PASS |
| Conservative throughput (1000 / p95 latency) | ≥ 20 FPS | 77.2–165.8 FPS | 3/3 on this host |
